...
(async () => {
  ...
  const browserURL = 'ws://127.0.0.1:9222/devtools/browser/c7d4d0e7-2983-4841-ab79-3470480de826';
  ...
  while (true) {
    ...
    try {
      ...
      if (clipboardContent.includes("https://www.mydomain.com/in/")) {
        ...
        await sendTelegram("Incorrect clipboard content. Need intervention!");
        break;
      }
    } catch (error) {
  ...
  await sendTelegram("Puppeteer run finished.");
